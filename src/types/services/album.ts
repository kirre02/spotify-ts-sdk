...
export type GetAlbumResponse = Schema.Schema.Type<typeof GetAlbumResponseSchema>;
...
export type GetSeveralAlbumResponse = Schema.Schema.Type<typeof GetSeveralAlbumResponseSchema>;
...
export type GetAlbumTracksResponse = Schema.Schema.Type<typeof GetAlbumTracksResponseSchema>;

export const GetSavedAlbumResponseSchema = PageSchema(SavedAlbumSchema);
export type GetSavedAlbumResponse = Schema.Schema.Type<typeof GetSavedAlbumResponseSchema>;
...
export type GetNewReleasesResponse = Schema.Schema.Type<typeof GetNewReleasesResponseSchema>;
