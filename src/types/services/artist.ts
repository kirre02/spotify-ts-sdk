...
import { imageSchema, PageSchema, SimplifiedAlbumSchema } from "@schemas/shared";
...
export type GetArtistResponse = Schema.Schema.Type<typeof GetArtistResponseSchema>;
...
export type GetSeveralArtistResponse = Schema.Schema.Type<typeof GetSeveralArtistResponseSchema>;
...
export type GetArtistAlbumResponse = Schema.Schema.Type<typeof GetArtistAlbumResponseSchema>;
