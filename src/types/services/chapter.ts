...
export type GetChapterResponse = Schema.Schema.Type<
	typeof GetChapterResponseSchema
>;
...
export type GetSeveralChapterResponse = Schema.Schema.Type<
	typeof GetSeveralChapterResponseSchema
>;
