...
import { externalUrlsSchema, imageSchema, PagedSetSchema, PageSchema } from "@schemas/shared";
...
export type GetCurrentUserResponse = Schema.Schema.Type<typeof GetCurrentUserResponseSchema>;

export const GetTopArtistsResponseSchema = PageSchema(ArtistSchema);
export type GetTopArtistsResponse = Schema.Schema.Type<typeof GetTopArtistsResponseSchema>;

export const GetTopTracksResponseSchema = PageSchema(TrackSchema);
export type GetTopTracksResponse = Schema.Schema.Type<typeof GetTopTracksResponseSchema>;
...
export type GetUserProfileResponse = Schema.Schema.Type<typeof GetUserProfileResponseSchema>;
...
export type GetFollowedArtistResponse = Schema.Schema.Type<typeof GetFollowedArtistResponseSchema>;
