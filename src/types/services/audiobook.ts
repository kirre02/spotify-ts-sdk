...
export type GetAudiobookResponse = Schema.Schema.Type<
	typeof GetAudiobookResponseSchema
>;
...
export const GetAudiobookChapterResponseSchema = PageSchema(
...
export const GetSavedAudiobookResponseSchema = PageSchema(
	SimplifiedAudiobookSchema,
);
export type GetSavedAudiobookResponse = Schema.Schema.Type<
	typeof GetSavedAudiobookResponseSchema
>;
