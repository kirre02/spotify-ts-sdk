...
export type GetEpisodeResponse = Schema.Schema.Type<typeof GetEpisodeResponseSchema>;
...
export type GetSeveralEpisodeResponse = Schema.Schema.Type<typeof GetSeveralEpisodeResponseSchema>;

export const GetSavedEpisodeResponseSchema = PageSchema(SavedEpisodeSchema);
export type GetSavedEpisodeResponse = Schema.Schema.Type<typeof GetSavedEpisodeResponseSchema>;
