...
export type GetPlaybackStateResponse = Schema.Schema.Type<
...
export const GetRecentlyPlayedResponseSchema =
	PagedSetSchema(PlayHistorySchema);
export type GetRecentlyPlayedResponse = Schema.Schema.Type<
	typeof GetRecentlyPlayedResponseSchema
>;
...
export type GetQueueResponse = Schema.Schema.Type<
	typeof GetQueueResponseSchema
>;
