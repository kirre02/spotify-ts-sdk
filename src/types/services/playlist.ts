...
export type GetPlaylistResponse = Schema.Schema.Type<
...
export type GetPlaylistItemResponse = Schema.Schema.Type<
	typeof GetPlaylistItemResponseSchema
>;
...
export type AddPlaylistItemResponse = Schema.Schema.Type<
...
export type RemovePlaylistItemResponse = Schema.Schema.Type<
	typeof AddPlaylistItemResponseSchema
>;
...
export type GetUserPlaylistResponse = Schema.Schema.Type<
	typeof GetUserPlaylistResponseSchema
>;
...
export type CreatePlaylistResponse = Schema.Schema.Type<
