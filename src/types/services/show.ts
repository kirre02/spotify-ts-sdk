...
export type GetSeveralShowResponse = Schema.Schema.Type<typeof GetSeveralShowResponseSchema>;
...
export type GetShowEpisodeResponse = Schema.Schema.Type<typeof GetShowEpisodeResponseSchema>;

export const GetSavedShowResponseSchema = PageSchema(SavedShowSchema);
export type GetSavedShowResponse = Schema.Schema.Type<typeof GetSavedShowResponseSchema>;
