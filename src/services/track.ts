...
export class TrackService extends Context.Tag("TrackService")<
  TrackService,
  {
    ...
    readonly save: (request: SaveTrackRequest) => Effect.Effect<void, ApiError, AuthService>;
    readonly remove: (request: RemoveTrackRequest) => Effect.Effect<void, ApiError, AuthService>;
    readonly checkSaved: (
  ...
  Effect.succeed(
    TrackService.of({
      get: (request: GetTrackRequest, options?: MarketOnlyOptions) => {
        ...
        if (options?.market != null) guardMarket(options.market, "[TrackService/Get]");
      ...
      getMany: (request: GetSeveralTrackRequest, options?: MarketOnlyOptions) => {
        ...
        if (options?.market != null) guardMarket(options.market, "[TrackService/GetMany]");
      ...
      getSaved: (options?: PaginatedMarketOptions) => {
        if (options?.market != null) guardMarket(options.market, "[TrackService/GetSaved]");
        if (options?.limit != null) guardLimit(options.limit, 50, "[TrackService/GetSaved]");
        if (options?.offset != null) guardOffset(options.offset, "[TrackService/GetSaved]");
      ...
      save: (request: SaveTrackRequest) => {
        ...
        if (ids != null) {
          ...
          guardTimestampedIds(timestamped_ids, "[TrackService/Save] Timestamped ids", 50);
