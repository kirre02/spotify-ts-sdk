...
export class AudiobookService extends Context.Tag("AudiobookService")<
  AudiobookService,
  {
    ...
    readonly save: (request: SaveAudiobookRequest) => Effect.Effect<void, ApiError, AuthService>;
    readonly remove: (
  ...
  Effect.succeed(
    AudiobookService.of({
      get: (request: GetAudiobookRequest, options?: MarketOnlyOptions) => {
        ...
        if (options?.market != null) guardMarket(options.market, "[AudiobookService/Get]");
      ...
      getMany: (request: GetSeveralAudiobookRequest, options?: MarketOnlyOptions) => {
        ...
        if (options?.market != null) guardMarket(options.market, "[AudiobookService/GetMany]");
      ...
      getChapters: (request: GetAudiobookChapterRequest, options?: PaginatedMarketOptions) => {
        ...
        if (options?.market != null) guardMarket(options.market, "[AudiobookService/GetChapters]");
        if (options?.limit != null) guardLimit(options.limit, 50, "[AudiobookService/GetChapters]");
        if (options?.offset != null) guardOffset(options.offset, "[AudiobookService/GetChapters]");
      ...
      getSaved: (options?: PaginationOptions) => {
        if (options?.limit != null) guardLimit(options.limit, 50, "[AudiobookService/GetSaved]");
        if (options?.offset != null) guardOffset(options.offset, "[AudiobookService/GetSaved]");
