...
import type { DateRangeOptions, MarketAdditionalTypesOptions } from "@schemas/options";
import {
...
export class PlayerService extends Context.Tag("PlayerService")<
  PlayerService,
  {
    ...
    readonly getDevices: () => Effect.Effect<GetAvailableDevicesResponse, ApiError, AuthService>;
    ...
    readonly skipToNext: (request: SkipToNextRequest) => Effect.Effect<void, ApiError, AuthService>;
    ...
    readonly getQueue: () => Effect.Effect<GetQueueResponse, ApiError, AuthService>;
    ...
    PlayerService.of({
      getPlaybackState: (options?: MarketAdditionalTypesOptions) => {
        ...
        if (options?.additional_types != null)
          guardAdditionalTypes(options.additional_types, "[PlayerService/GetPlaybackState]");
      ...
      getCurrentlyPlaying: (options?: MarketAdditionalTypesOptions) => {
        ...
        if (options?.additional_types != null)
          guardAdditionalTypes(options.additional_types, "[PlayerService/GetCurrentlyPlaying]");
      ...
      startOrResumePlayback: (request: StartOrResumePlaybackRequest) => {
        ...
        if (deviceId != null)
          guardString(deviceId, "[PlayerService/StartOrResumePlayback] Device id");
        ...
        if (contextUri != null)
          guardContextUri(contextUri, "[PlayerService/StartOrResumePlayback] Context uri");
        if (uris != null) guardUris(uris, "[PlayerService/StartOrResumePlayback] Uris");
        ...
        if (offset != null && "uri" in offset)
          guardSpotifyUri(offset.uri, "[PlayerService/StartOrResumePlayback] Offset uri");
        ...
        return makeRequest({
          method: "PUT",
          route: deviceId ? `me/player/play?device_id=${deviceId}` : "/me/player/play",
          schema: Schema.Void,
          body: {
      ...
      pausePlayback: (request: PausePlaybackRequest) => {
        ...
        if (deviceId != null) guardString(deviceId, "[PlayerService/PausePlayback] Device id");

        return makeRequest({
          method: "PUT",
          route: deviceId ? `me/player/pause?device_id=${deviceId}` : "me/player/pause",
          schema: Schema.Void,
        });
      },
      skipToNext: (request: SkipToNextRequest) => {
        ...
        if (deviceId != null) guardString(deviceId, "[PlayerService/SkipToNext] Device id");

        return makeRequest({
          method: "POST",
          route: deviceId ? `me/player/next?device_id=${deviceId}` : "me/player/next",
          schema: Schema.Void,
        });
      },
      skipToPrevious: (request: SkipToPreviousRequest) => {
        ...
        if (deviceId != null) guardString(deviceId, "[PlayerService/SkipToPrevious] Device id");

        return makeRequest({
          method: "POST",
          route: deviceId ? `me/player/previous?device_id=${deviceId}` : "me/player/previous",
          schema: Schema.Void,
        });
      },
      seekToPosition: (request: SeekToPositionRequest) => {
        ...
        if (deviceId != null) guardString(deviceId, "[PlayerService/SeekToPosition] Device id");
      ...
      setRepeatMode: (request: SetRepeatModeRequest) => {
        ...
        if (deviceId != null) guardString(deviceId, "[PlayerService/SetRepeatMode] Device id");
      ...
      setPlaybackVolume: (request: SetPlaybackVolumeRequest) => {
        ...
        if (deviceId != null) guardString(deviceId, "[PlayerService/SetPlaybackVolume] Device id");
      ...
      togglePlaybackShuffle: (request: TogglePlaybackShuffleRequest) => {
        ...
        if (deviceId != null)
          guardString(deviceId, "[PlayerService/TogglePlaybackShuffle] Device id");
      ...
      getRecentlyPlayed: (options?: DateRangeOptions) => {
        ...
        } else if (options != null && "before" in options && options.before != null) {
          guardTimestamp(options.before, "[PlayerService/GetRecentlyPlayed]");
        } else if (options != null && "after" in options && options.after != null) {
      ...
      addToPlaybackQueue: (request: AddToPlaybackQueueRequest) => {
        ...
        if (deviceId != null) guardString(deviceId, "[PlayerService/AddToPlaybackQueue] Device id");
