...
export class ShowService extends Context.Tag("ShowService")<
  ShowService,
  {
    ...
    readonly save: (request: SaveShowRequest) => Effect.Effect<void, ApiError, AuthService>;
    readonly remove: (
  ...
  Effect.succeed(
    ShowService.of({
      get: (request: GetShowRequest, options?: MarketOnlyOptions) => {
        ...
        if (options?.market != null) guardMarket(options.market, "[ShowService/Get]");
      ...
      getMany: (request: GetSeveralShowRequest, options?: MarketOnlyOptions) => {
        ...
        if (options?.market != null) guardMarket(options.market, "[ShowService/GetMany]");
      ...
      getEpisodes: (request: GetShowEpisodeRequest, options?: PaginatedMarketOptions) => {
        ...
        if (options?.market != null) guardMarket(options.market, "[ShowService/GetEpisodes]");
        if (options?.limit != null) guardLimit(options.limit, 50, "[ShowService/GetEpisodes]");
        if (options?.offset != null) guardOffset(options.offset, "[ShowService/GetEpisodes]");
      ...
      getSaved: (options?: PaginationOptions) => {
        if (options?.limit != null) guardLimit(options.limit, 50, "[ShowService/GetSaved]");
        if (options?.offset != null) guardOffset(options.offset, "[ShowService/GetSaved]");
      ...
      remove: (request: RemoveShowRequest, options?: MarketOnlyOptions) => {
        ...
        if (options?.market != null) guardMarket(options.market, "[ShowService/Remove]");
